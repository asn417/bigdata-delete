...
import com.asn.bigdata.utils.JSONUtils;
...
public class HDFSUtils {
    ...
    @PostConstruct
    public void setHdfsPath() {
        hdfsPath = this.path;
    }
    @PostConstruct
    public void setHdfsName() {
     ...
     */
    public  static void copyFileToHDFS(boolean delSrc, boolean overwrite,String srcFile,String destPath) throws Exception {
        // 源文件路径是Linux下的路径，如果在 windows 下测试，需要改写为Windows下的路径，比如D://hadoop/djt/weibo.txt
        Path srcPath = new Path(srcFile);
        FileSystem fs = getFileSystem();
        // 目的路径
        if(StringUtils.isNotBlank(hdfsPath)){
            destPath = hdfsPath + destPath;
        }
